...
function NewMonitorStartDarkMobile() {
  return (
    <div className="flex h-full w-full items-start bg-[#191919ff]">
      <div className="flex w-64 flex-none flex-col items-start justify-between self-stretch border-r border-solid border-neutral-800 bg-[#0d0d0dff] shadow-[0px_-8px_20px_0px_#0000001a,0px_0px_16px_0px_#0000000d] backdrop-blur-2xl z-10">
        <div className="flex w-full flex-col items-start gap-8 px-6 py-6">
          ...
          <div className="flex w-full flex-col items-start gap-2">
            ...
            <div className="flex w-full flex-col items-start gap-1">
              <div className="flex w-full items-center gap-3 rounded-md bg-brand-900 px-3 py-2 shadow-[0px_0px_20px_0px_#5833ff26] cursor-pointer">
                <FeatherHome className="text-body font-body text-brand-400" />
                <span className="text-body-bold font-body-bold text-brand-300">
                  Dashboard
                </span>
              </div>
      ...
      <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch overflow-y-auto">
        <div className="flex w-full items-center justify-between px-8 py-6">
          ...
          <Button
            className="hover:bg-brand-800 hover:shadow-[inset_0_0_24px_rgba(88,51,255,0.4)]"
        ...
        <div className="flex w-full flex-wrap items-start gap-6 px-8 py-8">
          <div className="flex min-w-[320px] max-w-[384px] grow shrink-0 basis-0 flex-col items-start gap-4 rounded-lg border border-solid border-neutral-700 bg-neutral-900 cursor-pointer transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
      ...
      <div className="flex items-center justify-center absolute inset-0 bg-neutral-950/60 backdrop-blur-sm z-50">
        <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch overflow-hidden bg-[#191919ff]">
          <div className="flex w-full items-center justify-between px-4 py-4">
            <div className="flex h-8 w-8 flex-none items-center justify-center rounded-md cursor-pointer hover:bg-neutral-800 hover:border border hover:border-brand-600 transition-colors border-transparent">
              <FeatherX className="text-body font-body text-neutral-200" />
            </div>
            <span className="text-body-bold font-body-bold text-neutral-0">
              New Monitor
            </span>
            <div className="flex h-8 w-8 flex-none items-center justify-center rounded-md border border-solid border-neutral-700 bg-neutral-900 cursor-pointer hover:bg-neutral-800">
          ...
          <div className="flex w-full flex-col items-start gap-2 px-4 pb-4">
            <div className="flex w-full items-center gap-3">
              <div className="flex h-1 grow shrink-0 basis-0 flex-col items-start rounded-full bg-neutral-700" />
          ...
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-y-auto">
            <div className="flex w-full items-start gap-3">
              <div className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-gradient-to-br from-brand-600 to-brand-500">
          ...
          <div className="flex w-full flex-col items-start px-4 py-4">
            <div className="flex w-full items-center gap-2 rounded-lg border border-solid border-neutral-700 bg-[#222222ff] px-4 py-3">
              <TextFieldUnstyled className="h-auto grow shrink-0 basis-0">
                <TextFieldUnstyled.Input
                  className="text-body font-body text-neutral-0 placeholder:text-neutral-500"
                  placeholder="Describe what you want to monitor..."
                  value=""
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => {}}
                />
              </TextFieldUnstyled>
              <div className="flex h-10 w-10 flex-none items-center justify-center rounded-md bg-[#5833ffff] cursor-pointer hover:bg-brand-700">
...
export default NewMonitorStartDarkMobile;
