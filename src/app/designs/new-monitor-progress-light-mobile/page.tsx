...
function NewMonitorProgressLightMobile() {
  return (
    <div className="flex h-full w-full items-start bg-gradient-to-br from-brand-100 via-brand-200 to-brand-300">
      ...
      <div className="flex items-center justify-center absolute inset-0 bg-neutral-900/20 backdrop-blur-sm z-50">
        <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch overflow-hidden bg-gradient-to-br from-brand-100 via-brand-200 to-brand-300">
          <div className="flex w-full items-center justify-between px-4 py-4">
            ...
            <span className="text-body-bold font-body-bold text-neutral-900">New Monitor</span>
            <div className="flex h-8 w-8 flex-none items-center justify-center rounded-md border border-solid border-neutral-200 bg-[#ffffffff] cursor-pointer hover:bg-brand-300">
              <FeatherEye className="text-body font-body text-neutral-600" />
            </div>
          </div>
          <div className="flex w-full flex-col items-start gap-2 px-4 pb-4">
            <div className="flex w-full items-center gap-3">
              <div className="flex h-1 grow shrink-0 basis-0 flex-col items-start rounded-full bg-neutral-200">
                <div className="flex h-1 flex-none flex-col items-start rounded-full bg-success-600 w-2/5" />
              </div>
              <span className="text-caption font-caption text-neutral-600">40% complete</span>
            </div>
          </div>
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-y-auto">
            ...
            <div className="flex w-full items-start gap-3">
              <div className="flex h-10 w-10 flex-none items-start" />
              <div className="flex grow shrink-0 basis-0 flex-col items-start gap-2 rounded-lg bg-brand-300 px-4 py-3">
            ...
            <div className="flex w-full items-start gap-3">
              ...
              <div className="flex grow shrink-0 basis-0 items-center gap-3">
                <div className="flex grow shrink-0 basis-0 flex-col items-center gap-2 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-6 py-4 cursor-pointer hover:border-brand-600 hover:bg-brand-50">
                  <FeatherTrendingUp className="text-heading-2 font-heading-2 text-brand-600" />
                  <span className="text-body-bold font-body-bold text-neutral-900">NASDAQ</span>
                </div>
                <div className="flex grow shrink-0 basis-0 flex-col items-center gap-2 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-6 py-4 cursor-pointer hover:border-brand-600 hover:bg-brand-50">
                  <FeatherNewspaper className="text-heading-2 font-heading-2 text-brand-600" />
                  <span className="text-body-bold font-body-bold text-neutral-900">News</span>
                </div>
              </div>
            </div>
          </div>
          <div className="flex w-full flex-col items-start px-4 py-4">
            <div className="flex w-full items-center gap-2 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-3 py-2">
...
export default NewMonitorProgressLightMobile;
