...
function NewMonitorProgressLightMobilePreview() {
  return (
        ...
        <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch overflow-hidden bg-gradient-to-br from-brand-100 via-brand-200 to-brand-300">
          <div className="flex w-full items-center justify-between px-4 py-4">
            <div className="flex h-8 w-8 flex-none items-center justify-center rounded-md cursor-pointer hover:bg-brand-300 hover:border border hover:border-brand-600 transition-colors border-transparent">
              <FeatherArrowLeft className="text-body font-body text-neutral-600" />
            </div>
          ...
          <div className="flex w-full flex-col items-start gap-2 px-4 pb-4">
            <span className="text-caption-bold font-caption-bold text-neutral-500">
              MONITOR PREVIEW
            </span>
            <div className="flex w-full items-center gap-3">
              <div className="flex h-1 grow shrink-0 basis-0 flex-col items-start rounded-full bg-neutral-100">
                <div className="flex grow shrink-0 basis-0 items-start rounded-full bg-success-700 w-[40%]" />
              </div>
              <span className="text-caption font-caption text-neutral-400">
                40% complete
              </span>
          ...
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-y-auto">
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-neutral-200 bg-success-200 px-4 py-3">
              <div className="flex w-full items-center justify-between">
                <div className="flex items-center gap-2">
                  <FeatherTarget className="text-body font-body text-neutral-900" />
            ...
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-3">
              <div className="flex items-center gap-2">
                <FeatherGlobe className="text-body font-body text-neutral-400" />
                <span className="text-caption-bold font-caption-bold text-neutral-400">
                  SOURCES
                </span>
              </div>
            ...
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-3">
              <div className="flex items-center gap-2">
                <FeatherZap className="text-body font-body text-neutral-400" />
                <span className="text-caption-bold font-caption-bold text-neutral-400">
                  UPDATE FREQUENCY
                </span>
              </div>
            ...
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-3">
              <div className="flex items-center gap-2">
                <FeatherBell className="text-body font-body text-neutral-400" />
                <span className="text-caption-bold font-caption-bold text-neutral-400">
                  ALERTS
                </span>
              </div>
...
export default NewMonitorProgressLightMobilePreview;
