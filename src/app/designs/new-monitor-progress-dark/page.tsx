...
function NewMonitorProgressDark() {
  return (
    <div className="flex h-full w-full items-start bg-neutral-950">
        ...
        <div className="flex w-full flex-col items-start gap-8 px-6 py-6">
          ...
          <div className="flex w-full flex-col items-start gap-2">
            ...
            <div className="flex w-full flex-col items-start gap-1">
              <div className="flex w-full items-center gap-3 rounded-md bg-brand-600 px-3 py-2 shadow-[0px_0px_20px_0px_#5833ff26] cursor-pointer">
                <FeatherHome className="text-body font-body text-[#ffffffff]" />
      ...
      <div className="flex items-center justify-center absolute inset-0 bg-neutral-900/80 backdrop-blur-sm z-50">
        <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch bg-neutral-900">
          ...
          <div className="flex w-full grow shrink-0 basis-0 items-stretch">
            <div className="flex flex-col items-start w-1/2">
                ...
                <div className="flex w-full items-start gap-3">
                  ...
                  <div className="flex grow shrink-0 basis-0 flex-col items-start gap-2 px-4 py-3">
                    <span className="text-body font-body text-neutral-100">
                      Hi! I&#39;m here to help you set up a new monitor. What
                      would you like to keep track of?
                    </span>
                  </div>
                </div>
                ...
                <div className="flex w-full items-start gap-3">
                  ...
                  <div className="flex grow shrink-0 basis-0 flex-col items-start gap-4">
                    ...
                    <div className="flex w-full items-center justify-center gap-4">
                      <div className="flex w-32 flex-none flex-col items-center gap-3 rounded-lg border border-solid border-neutral-700 bg-neutral-800 px-6 py-5 cursor-pointer hover:border-brand-500 transition-colors">
                        <FeatherTrendingUp className="text-body font-body text-neutral-200" />
                        <span className="text-body font-body text-neutral-100 text-center">
                          NASDAQ
                        </span>
                      </div>
                      <div className="flex w-32 flex-none flex-col items-center gap-3 rounded-lg border border-solid border-neutral-700 bg-neutral-800 px-6 py-5 cursor-pointer hover:border-brand-500 transition-colors">
                        <FeatherFileText className="text-body font-body text-neutral-200" />
                        <span className="text-body font-body text-neutral-100 text-center">
                          News
                        </span>
                      </div>
              ...
              <div className="flex w-full flex-col items-start px-6 py-6">
                <div className="flex w-full items-center gap-2 rounded-lg border border-solid border-neutral-700 bg-neutral-800 px-4 py-3">
            ...
            <div className="flex flex-col items-start gap-6 px-6 py-6 w-1/2 overflow-y-auto">
              <div className="flex w-full flex-col items-start gap-2">
                ...
                <div className="flex w-full items-center gap-3">
                  <div className="flex h-1 grow shrink-0 basis-0 flex-col items-start overflow-hidden rounded-full bg-neutral-700">
                    <div className="flex grow shrink-0 basis-0 items-start bg-success-600 w-[40%]" />
                  </div>
              ...
              <div className="flex w-full flex-col items-start gap-3">
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-success-600 px-4 py-4 relative">
                  ...
                  <div className="flex items-center gap-2">
                    <FeatherTarget className="text-body font-body text-success-600" />
                ...
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-success-600 px-4 py-4 relative">
                  ...
                  <span className="text-body font-body text-[#ffffffff]">
                    Track real-time stock price movements and changes for Nvidia
                    (NVDA)
                  </span>
                </div>
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-neutral-700 bg-neutral-800 px-4 py-4">
                  <div className="flex items-center gap-2">
...
export default NewMonitorProgressDark;
