...
function NewMonitorProgressDarkMobilePreview() {
  return (
          ...
          <div className="flex w-full flex-col items-start gap-2">
            ...
            <div className="flex w-full flex-col items-start gap-1">
              <div className="flex w-full items-center gap-3 rounded-md bg-brand-900 px-3 py-2 shadow-[0px_0px_20px_0px_#5833ff26] cursor-pointer">
                ...
                <span className="text-body-bold font-body-bold text-brand-400">
                  Dashboard
                </span>
              </div>
      ...
      <div className="flex items-center justify-center absolute inset-0 bg-neutral-950/80 backdrop-blur-sm z-50">
        <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch overflow-hidden bg-neutral-950">
          ...
          <div className="flex w-full flex-col items-start gap-2 px-4 pb-4">
            ...
            <div className="flex w-full items-center gap-3">
              <div className="flex h-1 grow shrink-0 basis-0 flex-col items-start rounded-full bg-neutral-800">
                <div className="flex grow shrink-0 basis-0 items-start rounded-full bg-success-600 w-[40%]" />
              </div>
          ...
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-y-auto">
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-success-600 bg-neutral-900 px-4 py-3">
              <div className="flex w-full items-center justify-between">
                <div className="flex items-center gap-2">
                  <FeatherTarget className="text-body font-body text-success-500" />
...
export default NewMonitorProgressDarkMobilePreview;
