            ...
            <div className="flex flex-col items-start gap-6 px-6 py-6 w-1/2 overflow-y-auto">
              <div className="flex w-full flex-col items-start gap-2">
                ...
                <div className="flex w-full items-center gap-3">
                  ...
                  <span className="text-caption font-caption text-neutral-400">0% complete</span>
                </div>
              </div>
              <div className="flex w-full flex-col items-start gap-3">
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-4">
                  ...
                  <span className="text-body font-body text-neutral-400 italic">Waiting for input...</span>
                </div>
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-4">
                  <div className="flex items-center gap-2">
                    <FeatherTarget className="text-body font-body text-neutral-500" />
                  ...
                  <span className="text-body font-body text-neutral-400 italic">Describe what you want to monitor...</span>
                </div>
                <div className="flex w-full flex-col items-start gap-1 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-4">
                  <div className="flex items-center gap-2">
...
export default NewMonitorStartLight;
