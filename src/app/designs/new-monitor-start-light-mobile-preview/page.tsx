...
function NewMonitorStartLightMobilePreview() {
  return (
          ...
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-y-auto">
            <div className="flex w-full flex-col items-start gap-3 rounded-lg border border-solid border-neutral-200 bg-[#ffffffff] px-4 py-3">
              <div className="flex items-center gap-2">
                <FeatherTarget className="text-body font-body text-neutral-400" />
                <span className="text-caption-bold font-caption-bold text-neutral-400">
                  MONITOR NAME
                </span>
              </div>
...
export default NewMonitorStartLightMobilePreview;
