...
/*
 * Documentation:
 * Vertical Stepper — https://app.subframe.com/51ef4e586a6b/library?component=Vertical+Stepper_bdc0291d-b5be-40c5-ae2f-527a868488b2
 */
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            "flex h-2 w-0.5 flex-none flex-col items-center gap-2 bg-light-secondary",
            { hidden: firstStep }
          )}
        />
        <div
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-bold font-body-bold text-light-primary text-center",
                {
        ...
        <div
          className={SubframeUtils.twClassNames(
            "flex min-h-[8px] w-0.5 grow shrink-0 basis-0 flex-col items-center gap-2 bg-light-secondary",
            { hidden: lastStep }
          )}
        />
      </div>
      ...
      >
        {label ? (
          <span
            className={SubframeUtils.twClassNames(
              "line-clamp-2 w-full text-body font-body text-light-primary",
              {
                "text-body-bold font-body-bold text-light-background":
                  variant === "active",
                "text-light-background": variant === "completed",
              }
            )}
          >
            {label}
