...
/*
 * Documentation:
 * Stepper — https://app.subframe.com/51ef4e586a6b/library?component=Stepper_3c5d47dc-1b1a-45d9-b244-18422d7bfb56
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-caption-bold font-caption-bold text-light-primary",
                {
                  "text-brand-700":
      ...
      {label ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-body font-body text-light-primary group-hover/c1145464:text-light-background",
            {
