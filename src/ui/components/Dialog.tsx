...
/*
 * Documentation:
 * Dialog — https://app.subframe.com/51ef4e586a6b/library?component=Dialog_ca59db17-43fb-4247-8094-3c55162e902d
 */
    ...
    <SubframeCore.Dialog.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex min-w-[320px] flex-col items-start gap-2 rounded-md border border-solid border-neutral-50 bg-dark-text shadow-lg max-h-[90vh] overflow-auto",
          className
        )}
        ref={ref}
      >
