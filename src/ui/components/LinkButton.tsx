...
/*
 * Documentation:
 * Link Button — https://app.subframe.com/51ef4e586a6b/library?component=Link+Button_a4ee726a-774c-4091-8c49-55b659356024
 */
          ...
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body font-body text-neutral-700 group-hover/a4ee726a:text-brand-700 group-disabled/a4ee726a:text-neutral-400 group-hover/a4ee726a:group-disabled/a4ee726a:text-neutral-400",
              {
                ...
                "text-light-accent group-hover/a4ee726a:text-light-accent":
                  variant === "inverse",
