...
/*
 * Documentation:
 * Toast — https://app.subframe.com/51ef4e586a6b/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
 */
    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/2c7966c2 flex w-80 items-center gap-4 rounded-md bg-dark-text px-4 py-3 shadow-lg",
          className
        )}
        ref={ref}
        {...otherProps}
      >
        ...
        <div className="flex grow shrink-0 basis-0 flex-col items-start">
          {title ? (
            <span
              className={SubframeUtils.twClassNames(
                "w-full text-body-bold font-body-bold text-light-background",
                {
                  "text-success-700": variant === "success",
                  "text-error-700": variant === "error",
          ...
          {description ? (
            <span className="w-full text-caption font-caption text-light-primary">
              {description}
            </span>
          ) : null}
        </div>
