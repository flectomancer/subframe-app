...
/*
 * Documentation:
 * Copy to clipboard button — https://app.subframe.com/51ef4e586a6b/library?component=Copy+to+clipboard+button_e8c76626-6462-4f2f-b595-38d530d427e8
 * Tooltip — https://app.subframe.com/51ef4e586a6b/library?component=Tooltip_ccebd1e9-f6ac-4737-8376-0dfacd90c9f3
 */
      ...
      <SubframeCore.Tooltip.Root>
        <SubframeCore.Tooltip.Trigger asChild={true}>
          ...
          >
            ...
            >
              {icon ? (
                <SubframeCore.IconWrapper className="text-body font-body text-light-primary group-hover/e8c76626:text-light-background">
                  {icon}
