...
/*
 * Documentation:
 * Button — https://app.subframe.com/51ef4e586a6b/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
      ...
      <button
        className={SubframeUtils.twClassNames(
          "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-2 rounded-md border-none bg-brand-600 px-3 text-left hover:bg-brand-500 active:bg-brand-600 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
            ...
            "border border-solid border-neutral-50 bg-dark-text hover:bg-neutral-50 active:bg-dark-text":
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body font-body text-light-accent group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
        ...
        >
          <SubframeCore.Loader
            className={SubframeUtils.twClassNames(
              "font-['Inter'] text-[12px] font-[400] leading-[20px] text-light-accent group-disabled/3b777358:text-neutral-400",
              {
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-body-bold font-body-bold text-light-accent group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
