...
/*
 * Documentation:
 * Select — https://app.subframe.com/51ef4e586a6b/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
    ...
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-md border border-solid border-neutral-50 bg-light-accent px-1 py-1 shadow-lg",
          className
        )}
        ref={ref}
      >
  ...
  function ItemText(
    ...
    return children ? (
      <SubframeCore.Select.ItemText {...otherProps}>
        <span
          className={SubframeUtils.twClassNames(
            "text-body font-body text-light-background",
            className
          )}
          ref={ref}
        >
    ...
    return (
      <SubframeCore.Select.Trigger asChild={true} {...otherProps}>
        ...
        >
          ...
          <FeatherChevronDown className="text-body font-body text-light-primary" />
        </button>
...
>(function TriggerValue(
  ...
  return (
    <SubframeCore.Select.Value
      className={SubframeUtils.twClassNames(
        "w-full whitespace-nowrap text-body font-body text-light-background",
        className
      )}
      ref={ref}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-50 bg-dark-text group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-neutral-900",
              {
