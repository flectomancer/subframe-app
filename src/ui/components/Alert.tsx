...
/*
 * Documentation:
 * Alert — https://app.subframe.com/51ef4e586a6b/library?component=Alert_3a65613d-d546-467c-80f4-aaba6a7edcd5
 */
        ...
        <div className="flex w-full items-center gap-4">
          ...
          <div className="flex grow shrink-0 basis-0 flex-col items-start">
            {title ? (
              <span
                className={SubframeUtils.twClassNames(
                  "w-full whitespace-pre-wrap text-body-bold font-body-bold text-light-background",
                  {
            ...
            {description ? (
              <span
                className={SubframeUtils.twClassNames(
                  "w-full whitespace-pre-wrap text-caption font-caption text-light-primary",
                  {
                    "text-warning-800": variant === "warning",
                    "text-success-800": variant === "success",
                    "text-error-800": variant === "error",
