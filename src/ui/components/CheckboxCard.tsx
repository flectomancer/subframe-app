...
/*
 * Documentation:
 * Checkbox Card — https://app.subframe.com/51ef4e586a6b/library?component=Checkbox+Card_de0b4dfb-3946-4702-be52-5678dd71925a
 */
    ...
    >
      <button
        className={SubframeUtils.twClassNames(
          "group/de0b4dfb flex cursor-pointer items-center gap-4 rounded-md border border-solid border-neutral-50 bg-dark-text px-4 py-3 text-left hover:bg-neutral-50 aria-[checked=true]:border aria-[checked=true]:border-solid aria-[checked=true]:border-brand-200 aria-[checked=true]:bg-brand-50 hover:aria-[checked=true]:bg-brand-50 disabled:cursor-default disabled:border disabled:border-solid disabled:border-neutral-100 disabled:bg-neutral-100 hover:disabled:cursor-default hover:disabled:bg-neutral-100",
          className
        )}
        ref={ref}
      >
        ...
        >
          <FeatherCheck className="hidden font-['Inter'] text-[16px] font-[400] leading-[16px] text-light-accent group-aria-[checked=true]/de0b4dfb:inline-flex group-disabled/de0b4dfb:text-neutral-400" />
        </div>
        {children ? (
