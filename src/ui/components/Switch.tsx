...
/*
 * Documentation:
 * Switch — https://app.subframe.com/51ef4e586a6b/library?component=Switch_7a464794-9ea9-4040-b1de-5bfb2ce599d9
 */
    ...
    <SubframeCore.Switch.Thumb asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-3.5 w-3.5 flex-col items-start gap-2 rounded-full bg-light-accent shadow-sm",
          className
        )}
        ref={ref}
      />
