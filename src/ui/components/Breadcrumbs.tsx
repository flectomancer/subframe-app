...
/*
 * Documentation:
 * Breadcrumbs — https://app.subframe.com/51ef4e586a6b/library?component=Breadcrumbs_8898334b-a66f-4ee8-8bd1-afcfa8e37cc0
 */
  ...
  return children ? (
    <span
      className={SubframeUtils.twClassNames(
        "group/bbdc1640 line-clamp-1 cursor-pointer break-words text-body font-body text-light-primary hover:text-light-background",
