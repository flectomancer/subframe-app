...
/*
 * Documentation:
 * Fullscreen Dialog — https://app.subframe.com/51ef4e586a6b/library?component=Fullscreen+Dialog_3f094173-71de-4378-a09a-05c482f7a137
 */
    ...
    <SubframeCore.FullScreenDialog.Root asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-full w-full flex-col items-start bg-dark-text",
          className
        )}
        ref={ref}
      >
